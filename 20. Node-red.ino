...
{ if(getPB()==1)
  ...
  text.trim(); // remove any newline or carriage return

  if (text == "ten")        { beep(1,50); cnt += 10; }
  else if (text == "one")   { beep(1,50); cnt++;     }
  else if (text == "start") startCnt();
  }
  Serial.println(cnt);
}
